...
latex_documents = [
    ('index', 'tripleo-ansibleReleaseNotes.tex',
     u'tripleo-ansible Release Notes Documentation',
...
man_pages = [
    ('index', 'tripleo-ansiblereleasenotes',
     u'tripleo-ansible Release Notes Documentation',
...
texinfo_documents = [
    ('index', 'tripleo-ansibleReleaseNotes',
     u'tripleo-ansible Release Notes Documentation',
     u'2016, TripleO Developers', 'tripleo-ansibleReleaseNotes',
